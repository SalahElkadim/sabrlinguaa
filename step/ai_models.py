...
class AIGenerationJob(models.Model):
    ...
    skill = models.ForeignKey(
        'step.STEPSkill', on_delete=models.SET_NULL,
        null=True, blank=True, related_name='generation_jobs'
    )
    books = models.ManyToManyField(ExtractedBook, blank=True, related_name='generation_jobs')
    media = models.ManyToManyField(ExtractedMedia, blank=True, related_name='generation_jobs')
