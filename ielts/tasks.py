...
3. نص السؤال والخيارات يجب أن تكون باللغة الإنجليزية فقط
  ...
  "questions": [
    {
      ...
      "explanation": "كلمة Abundant تعني موجود بكثرة.",
  ...
  "questions": [
    {
      ...
      "correct_answer": "goes",
      "explanation": "في المضارع البسيط يُضاف 's' مع ضمير الغائب المفرد.",
      ...
      "questions": [
        {
          ...
          "explanation": "طلب الموظف رؤية جواز السفر مما يدل على المطار.",
      ...
      "questions": [
        {
          ...
          "correct_answer": "7am",
          "explanation": "سارة استيقظت مبكرا ..",
