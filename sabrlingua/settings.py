...
# settings.py
MOYASAR_WEBHOOK_SECRET_BOOKING = os.getenv('MOYASAR_WEBHOOK_SECRET_BOOKING')
MOYASAR_WEBHOOK_SECRET_IELTS   = os.getenv('MOYASAR_WEBHOOK_SECRET_IELTS')
MOYASAR_WEBHOOK_SECRET_STEP    = os.getenv('MOYASAR_WEBHOOK_SECRET_STEP')
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'sabr_auth.exceptions.custom_exception_handler',
...
# Email Configuration using Anymail + Brevo
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware',  # للـ CORS
...
WSGI_APPLICATION = 'sabrlingua.wsgi.application'

# Database
# https://docs.djangoproject.com/en/5.2/ref/settings/#databases

# استخدام dj_database_url للتعامل مع SQLite و PostgreSQL
DATABASES = {
...
LANGUAGE_CODE = 'en-us'
TIME_ZONE = 'Africa/Cairo'  # غيرتها لتوقيت مصر
USE_I18N = True
USE_TZ = True
